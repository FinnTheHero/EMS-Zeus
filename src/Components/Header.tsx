            ...
            <nav className="bg-transparent">
                <div className="mx-auto max-w-7xl px-5 lg:px-4 border-b border-gray-800">
                    <div className="flex h-16 items-center justify-between">
                      ...
                      --> */}
                                    <div
                                        className={`${showUserProfileMenu ? "block" : "hidden"} absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black/5 focus:outline-none`}
                                        role="menu"
                ...
                >
                    ...
                    <div className="border-t border-gray-700 pb-3 pt-4">
                        ...
                        <div className="hidden mt-3 space-y-1 px-2">
                            <a
                                href="/#"
